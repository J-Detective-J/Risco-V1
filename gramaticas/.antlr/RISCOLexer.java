...
public class RISCOLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "T__13", "T__14", "T__15", "FOR", 
			"IN", "END", "VAL", "VAR", "PRINT", "IF", "ELIF", "ELSE", "WHILE", "AND", 
			"OR", "EQ", "NEQ", "GTE", "LTE", "NUMERO", "DECIMAL", "STRING", "BOOLEANO", 
			"NULL", "IDENTIFICADOR", "LETRA", "DIGITO", "NL", "WS", "COMENTARIO_LINEA", 
	...
	public RISCOLexer(CharStream input) {
		super(input);
