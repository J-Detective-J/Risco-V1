...
public class RISCOLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "T__13", "FOR", "IN", "END", "VAL", 
			"VAR", "PRINT", "NUMERO", "DECIMAL", "STRING", "BOOLEANO", "NULL", "IDENTIFICADOR", 
			"LETRA", "DIGITO", "NL", "WS", "COMENTARIO_LINEA", "COMENTARIO_BLOQUE", 
			"COMENTARIO_DOC"
		};
	}
